    ...
    exit(rustc_driver::catch_with_exit_code(move || {
        ...
        let clippy_args = clippy_args_var
            ...
            .chain(vec![
                ...
                "-A".into(),
                "binary-asm-labels".into(),
                "-A".into(),
                "bindings-with-variant-name".into(),
                "-A".into(),
                "conflicting-repr-hints".into(),
                "-A".into(),
                "default-overrides-default-fields".into(),
                "-A".into(),
                "elided-lifetimes-in-associated-constant".into(),
                "-A".into(),
                "enum-intrinsics-non-enums".into(),
                "-A".into(),
                "explicit-builtin-cfgs-in-flags".into(),
                "-A".into(),
                "ill-formed-attribute-input".into(),
                "-A".into(),
                "incomplete-include".into(),
                "-A".into(),
                "ineffective-unstable-trait-impl".into(),
                "-A".into(),
                "invalid-atomic-ordering".into(),
                "-A".into(),
                "invalid-doc-attributes".into(),
                "-A".into(),
                "invalid-from-utf8-unchecked".into(),
                "-A".into(),
                "invalid-null-arguments".into(),
                "-A".into(),
                "invalid-reference-casting".into(),
                "-A".into(),
                "invalid-type-param-default".into(),
                "-A".into(),
                "let-underscore-lock".into(),
                "-A".into(),
                "long-running-const-eval".into(),
                "-A".into(),
                "macro-expanded-macro-exports-accessed-by-absolute-paths".into(),
                "-A".into(),
                "missing-fragment-specifier".into(),
                "-A".into(),
                "mutable-transmutes".into(),
                "-A".into(),
                "named-asm-labels".into(),
                "-A".into(),
                "no-mangle-const-items".into(),
                "-A".into(),
                "overflowing-literals".into(),
                "-A".into(),
                "patterns-in-fns-without-body".into(),
                "-A".into(),
                "proc-macro-derive-resolution-fallback".into(),
                "-A".into(),
                "pub-use-of-private-extern-crate".into(),
                "-A".into(),
                "soft-unstable".into(),
                "-A".into(),
                "test-unstable-lint".into(),
                "-A".into(),
                "text-direction-codepoint-in-comment".into(),
                "-A".into(),
                "text-direction-codepoint-in-literal".into(),
                "-A".into(),
                "unconditional-panic".into(),
                "-A".into(),
                "undropped-manually-drops".into(),
                "-A".into(),
                "unknown-crate-types".into(),
                "-A".into(),
                "useless-deprecated".into(),
            ])
            .collect::<Vec<String>>();
